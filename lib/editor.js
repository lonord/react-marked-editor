...
class ReactMarkedEditor extends Component {
	...
	render() {
		...
		let { markdownClassName, markdownStyle, editorHeight, hideToolbar, toolbarCustomButtons } = this.props;
		if (!other.style) {
			other.style = {};
		}
		const styles = {
		...
		delete other.editorHeight;
		delete other.style.height;
		delete other.hideToolbar;
		delete other.toolbarCustomButtons;
		return (
			<div {...other}>
				{!hideToolbar
					? <ToolBar
