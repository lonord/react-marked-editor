		...
		return (
			<div {...other}>
				<div className="toolbar">
					<div className="btn-wrapper-first btn-wrapper">
						<ActionButton width={30} height={30}
							iconClass="fa-bold" onClick={this.handleToolbarAction.bind(this, 'bold')}/>
					</div>
					<div className="btn-wrapper">
						<ActionButton width={30} height={30}
							iconClass="fa-strikethrough" onClick={this.handleToolbarAction.bind(this, 'remove')}/>
					</div>
					<div className="btn-wrapper">
						<ActionButton width={30} height={30}
							iconClass="fa-italic" onClick={this.handleToolbarAction.bind(this, 'italic')}/>
					</div>
					<div className="btn-wrapper">
						<ActionButton width={30} height={30}
							iconClass="fa-code" onClick={this.handleToolbarAction.bind(this, 'code-inline')}/>
					</div>
					<div className="btn-wrapper btn-wrapper-separator">
						<ActionSeparator width={1} height={12}/>
					</div>
					<div className="btn-wrapper">
						<ActionButton width={30} height={30}
							text="H1" onClick={this.handleToolbarAction.bind(this, 'h1')}/>
					</div>
					<div className="btn-wrapper">
						<ActionButton width={30} height={30}
							text="H2" onClick={this.handleToolbarAction.bind(this, 'h2')}/>
					</div>
					<div className="btn-wrapper">
						<ActionButton width={30} height={30}
							text="H3" onClick={this.handleToolbarAction.bind(this, 'h3')}/>
					</div>
					<div className="btn-wrapper">
						<ActionButton width={30} height={30}
							text="H4" onClick={this.handleToolbarAction.bind(this, 'h4')}/>
					</div>
					<div className="btn-wrapper">
						<ActionButton width={30} height={30}
							text="H5" onClick={this.handleToolbarAction.bind(this, 'h5')}/>
					</div>
					<div className="btn-wrapper">
						<ActionButton width={30} height={30}
							text="H6" onClick={this.handleToolbarAction.bind(this, 'h6')}/>
					</div>
					<div className="btn-wrapper btn-wrapper-separator">
						<ActionSeparator width={1} height={12}/>
					</div>
					<div className="btn-wrapper">
						<ActionButton width={30} height={30}
							iconClass="fa-quote-left" onClick={this.handleToolbarAction.bind(this, 'quote')}/>
					</div>
					<div className="btn-wrapper">
						<ActionButton width={30} height={30}
							iconClass="fa-list-ul" onClick={this.handleToolbarAction.bind(this, 'ul')}/>
					</div>
					<div className="btn-wrapper">
						<ActionButton width={30} height={30}
							iconClass="fa-list-ol" onClick={this.handleToolbarAction.bind(this, 'ol')}/>
					</div>
					<div className="btn-wrapper">
						<ActionButton width={30} height={30}
							iconClass="fa-minus" onClick={this.handleToolbarAction.bind(this, 'separate')}/>
					</div>
					<div className="btn-wrapper btn-wrapper-separator">
						<ActionSeparator width={1} height={12}/>
					</div>
					<div className="btn-wrapper">
						<ActionButton width={30} height={30}
							iconClass="fa-link" onClick={this.handleToolbarAction.bind(this, 'link')}/>
					</div>
					<div className="btn-wrapper">
						<ActionButton width={30} height={30}
							iconClass="fa-picture-o" onClick={this.handleToolbarAction.bind(this, 'image')}/>
					</div>
					<div className="btn-wrapper">
						<ActionButton width={30} height={30}
							iconClass="fa-file-code-o" onClick={this.handleToolbarAction.bind(this, 'code')}/>
					</div>
					<div className="btn-wrapper">
						<ActionButton width={30} height={30}
							iconClass="fa-table" onClick={this.handleToolbarAction.bind(this, 'table')}/>
					</div>
				</div>	
