...
var _specialRenderer = require('./util/special-renderer');

var _specialRenderer2 = _interopRequireDefault(_specialRenderer);
...
var ReactMarkedView = function (_Component) {
    _inherits(ReactMarkedView, _Component);

    function ReactMarkedView(props) {
        _classCallCheck(this, ReactMarkedView);

        return _possibleConstructorReturn(this, (ReactMarkedView.__proto__ || Object.getPrototypeOf(ReactMarkedView)).call(this, props));
    }

    _createClass(ReactMarkedView, [{
        key: 'render',
        value: function render() {
            var _props = this.props,
                ...
                markdownClass = _props.markdownClass,
                style = _props.style;

            var renderer = new _marked2.default.Renderer();
            renderer.em = _specialRenderer2.default.em;
            renderer.image = _specialRenderer2.default.image;
            markedOptions && _marked2.default.setOptions(Object.assign({
...
exports.default = ReactMarkedView;